...
public class MicrocicloControllerTest {
    ...
    @Test
    public void testActualizarVolumenesVacios() {
        MicrocicloController mC = mock(MicrocicloController.class);
        ObjectId idMacrociclo = new ObjectId("6540abc7eb7a0415d79ba288");
        ObjectId idMesociclo = new ObjectId("6540abc7eb7a0415d79ba27f");
        List<Microciclo> lista = new ArrayList<>();
    ...
    @Test
    public void testValidarMicrociclo() {
        MicrocicloController mC = mock(MicrocicloController.class);
        ObjectId idMacrociclo = new ObjectId("6540abc7eb7a0415d79ba288");
        ObjectId idMesociclo = new ObjectId("6540abc7eb7a0415d79ba27f");
        List<Microciclo> lista = new ArrayList<>();
        ...
        when(mC.validarMicrociclos(idMacrociclo, idMesociclo, lista)).thenReturn(true);
        
        assertTrue(mC.validarMicrociclos(idMacrociclo, idMesociclo, lista));
    }
    
    @Test
    public void testValidarElementosNulos() {
        MicrocicloController mC = mock(MicrocicloController.class);
        when(mC.validarMicrociclos(null, null, null)).thenThrow(NegocioException.class);
        
        assertThrows(NegocioException.class, () -> {
            mC.validarMicrociclos(null, null, null);
        });
    }
    
    @Test
    public void testValidarMicrociclosVacios() {
        MicrocicloController mC = mock(MicrocicloController.class);
        ObjectId idMacrociclo = new ObjectId("6540abc7eb7a0415d79ba288");
        ObjectId idMesociclo = new ObjectId("6540abc7eb7a0415d79ba27f");
        
        when(mC.validarMicrociclos(idMacrociclo, idMesociclo, new ArrayList<>())).thenThrow(NegocioException.class);
        
        assertThrows(NegocioException.class, () -> {
            mC.validarMicrociclos(idMacrociclo, idMesociclo, new ArrayList<>());
        });
    }
    
    @Test
    public void testValidarVolumenesVacios() {
        MicrocicloController mC = mock(MicrocicloController.class);
        ObjectId idMacrociclo = new ObjectId("6540abc7eb7a0415d79ba288");
        ObjectId idMesociclo = new ObjectId("6540abc7eb7a0415d79ba27f");
        List<Microciclo> lista = new ArrayList<>();
        ...
        when(mC.validarMicrociclos(idMacrociclo, idMesociclo, lista)).thenThrow(NegocioException.class);
        
        assertThrows(NegocioException.class, () -> {
            mC.validarMicrociclos(idMacrociclo, idMesociclo, lista);
        });
    }
    
    @Test
    public void testValidarVolumenesNegativos() {
        MicrocicloController mC = mock(MicrocicloController.class);
        ObjectId idMacrociclo = new ObjectId("6540abc7eb7a0415d79ba288");
        ObjectId idMesociclo = new ObjectId("6540abc7eb7a0415d79ba27f");
        List<Microciclo> lista = new ArrayList<>();
    ...
    @Test
    public void testValidarAnioMenorActual() {
        MicrocicloController mC = mock(MicrocicloController.class);
        ObjectId idMacrociclo = new ObjectId("6540abc7eb7a0415d79ba288");
        ObjectId idMesociclo = new ObjectId("6540abc7eb7a0415d79ba27f");
        List<Microciclo> lista = new ArrayList<>();
    ...
    @Test
    public void testValiarFechaFinIgualInicio() {
        MicrocicloController mC = mock(MicrocicloController.class);
        ObjectId idMacrociclo = new ObjectId("6540abc7eb7a0415d79ba288");
        ObjectId idMesociclo = new ObjectId("6540abc7eb7a0415d79ba27f");
        List<Microciclo> lista = new ArrayList<>();
    ...
    @Test
    public void testValidarFechasNoSon5Dias() {
        MicrocicloController mC = mock(MicrocicloController.class);
        ObjectId idMacrociclo = new ObjectId("6540abc7eb7a0415d79ba288");
        ObjectId idMesociclo = new ObjectId("6540abc7eb7a0415d79ba27f");
        List<Microciclo> lista = new ArrayList<>();
